...
Using a local or embedded database (H2, local PostgreSQL/MySQL) is acceptable for development, but it is **fundamentally unsafe for production** due to:
...
- It does not prevent bad credential handling in your code  
...
| Concern      | EC2 Database | Amazon RDS |
|-------------|-------------|------------|
...
- Subnet selection directly impacts accessibility  
...
- RDS security group must:
  ...
  - Restrict source to the **application’s security group**
